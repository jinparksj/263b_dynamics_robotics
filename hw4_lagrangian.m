...
dh = [0 0 0 theta1; -pi/2 0 0 theta2;0 l2 0 theta3; 0 l3 0 0];
...
%Inertia tensor
Ic1 = [I_1_xx, -I_1_xy, -I_1_xz; -I_1_xy, I_1_yy, -I_1_yz; -I_1_xz, -I_1_yz, I_1_zz];
Ic2 = [I_2_xx, -I_2_xy, -I_2_xz; -I_2_xy, I_2_yy, -I_2_yz; -I_2_xz, -I_2_yz, I_2_zz];
Ic3 = [I_3_xx, -I_3_xy, -I_3_xz; -I_3_xy, I_3_yy, -I_3_yz; -I_3_xz, -I_3_yz, I_3_zz];
...
jacobian = [-l2 * cos(theta2) * sin(theta1) - l3 * cos(theta2 + theta3) * sin(theta1), -l3 * cos(theta1) * sin(theta2 + theta3) - l2 * cos(theta1) * sin(theta2), -l3 * cos(theta1) * sin(theta2 + theta3);...
    l2 * cos(theta1) * cos(theta2) + l3 * cos(theta1) * cos(theta2 + theta3), -l2 * sin(theta1) * sin(theta2) - l3 * sin(theta1) * sin(theta2 + theta3), -l3 * sin(theta1) * sin(theta2 + theta3);...
